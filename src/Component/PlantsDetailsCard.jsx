...
const PlantsDetailsCard = ({ detail, allPlants }) => {
  ...
  return (
    <div className="bg-linear-to-b from-green-50 via-emerald-50/40 to-teal-50/60 min-h-screen pb-20">
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="lg:w-7/12 space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div className="bg-linear-to-br from-green-50 to-emerald-50 p-4 rounded-xl text-center border border-green-200">
              ...
              <div className="bg-linear-to-r from-green-50 to-emerald-50 p-5 rounded-xl border border-green-200">
      ...
      <div className="max-w-6xl mx-auto mt-16 px-4">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border-t-4 border-green-500">
          <h2 className="text-4xl font-bold bg-linear-to-r from-green-700 to-emerald-600 bg-clip-text text-transparent mb-8 text-center">
            🌱 Care Guide
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-linear-to-br from-green-50 to-emerald-50 p-6 rounded-2xl border-2 border-green-200 hover:shadow-lg transition-shadow">
            ...
            <div className="bg-linear-to-br from-blue-50 to-cyan-50 p-6 rounded-2xl border-2 border-blue-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
            ...
            <div className="bg-linear-to-br from-purple-50 to-pink-50 p-6 rounded-2xl border-2 border-purple-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
                <span className="text-3xl mr-3">💨</span>
